      ...
      {step === 1 ? (
        ...
        <form onSubmit={handleStep2} className="flex flex-col gap-3">
          ...
          <select required name="revenue" className={`h-11 rounded-lg px-4 text-sm border ${isDark ? "bg-white/10 border-white/20 text-white" : "bg-foreground/5 border-border text-foreground"}`}>
            ...
            <option>Under BHD 5K</option>
            <option>BHD 5K – BHD 20K</option>
            <option>BHD 20K – BHD 100K</option>
            <option>BHD 100K+</option>
          </select>
    ...
    <>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <motion.div initial="hidden" animate="visible" variants={stagger} className="space-y-6">
              ...
              <motion.h1 variants={fadeUp} className="text-4xl md:text-5xl lg:text-[3.4rem] font-extrabold leading-[1.1] text-white">
                Launch Your <span className="bg-gradient-to-r from-primary to-orange-400 bg-clip-text text-transparent">Shopify Store</span> in Bahrain
              </motion.h1>
              <motion.p variants={fadeUp} className="text-lg text-white/70 max-w-xl leading-relaxed">
                Scale your brand with the leading Shopify development agency in Bahrain. From custom design to integration with local payment gateways and logistics — we build stores that convert.
              </motion.p>
              <motion.div variants={fadeUp} className="flex flex-wrap gap-4 text-sm text-white/60">
                {["Official Partners", "BenefitPay Setup", "Logistics Integration", "Conversion Optimized"].map((t) => (
              ...
              <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-8 relative overflow-hidden group hover:bg-white/10 transition-colors">
                <div className="flex items-center gap-4 mb-8">
                  ...
                  <div>
                    ...
                    <p className="text-white/40 text-sm">Manama, Riffa, Muharraq</p>
                  </div>
                </div>
                <div className="space-y-4">
                  {[
                    { icon: CreditCard, title: "Bahrain Payment Gateways", desc: "BenefitPay, MyFatoorah, Tap, Sadad." },
                    { icon: Truck, title: "Logistics Bahrain", desc: "Bahrain Post, Aramex, DHL." },
                    { icon: Languages, title: "Arabic Localization", desc: "RTL design & multi-lingual setup." },
                  ].map((item, i) => (
      ...
      <section className="bg-card border-b border-border py-6">
        <div className="container mx-auto px-6">
          <div className="flex flex-wrap justify-center items-center gap-8 md:gap-12">
            {[
              { val: "35+", label: "Bahrain Stores Launched" },
              { val: "BHD 3M+", label: "GMV Processed" },
              { val: "Dedicated", label: "Project Management" },
      ...
      <section className="py-16 md:py-24 bg-background">
        <div className="container mx-auto px-6 text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-8 text-foreground">Ready to Scale Your Brand in Bahrain?</h2>
          <p className="text-muted-foreground mb-12 max-w-2xl mx-auto">Join the leading brands in Bahrain that trust Globify for their Shopify success. Get your free strategy session today.</p>
      ...
      <section className="py-20 md:py-28 section-dark relative overflow-hidden">
        ...
        <div className="container mx-auto px-6 relative z-10 text-center">
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={stagger} className="max-w-2xl mx-auto">
            <motion.h2 variants={fadeUp} className="text-3xl md:text-4xl font-bold text-white mb-6">Create a Store That Bahraini Customers Love</motion.h2>
            <motion.p variants={fadeUp} className="text-white/60 mb-10">Stop guessing and start selling. Our Shopify team is ready to take your brand to the next level.</motion.p>
            <motion.div variants={fadeUp} className="flex justify-center mb-8"><InlineLeadForm id="final-bh" variant="dark" /></motion.div>
