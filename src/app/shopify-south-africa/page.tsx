      ...
      {step === 1 ? (
        ...
        <form onSubmit={handleStep2} className="flex flex-col gap-3">
          ...
          <select required name="revenue" className={`h-11 rounded-lg px-4 text-sm border ${isDark ? "bg-white/10 border-white/20 text-white" : "bg-foreground/5 border-border text-foreground"}`}>
            ...
            <option>Under R250K</option>
            <option>R250K – R1M</option>
    ...
    <>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <motion.div initial="hidden" animate="visible" variants={stagger} className="space-y-6">
              ...
              <motion.h1 variants={fadeUp} className="text-4xl md:text-5xl lg:text-[3.4rem] font-extrabold leading-[1.1] text-white">
                Build Your <span className="bg-gradient-to-r from-primary to-orange-400 bg-clip-text text-transparent">Shopify Store</span> in South Africa
              </motion.h1>
              <motion.p variants={fadeUp} className="text-lg text-white/70 max-w-xl leading-relaxed">
                Scale your brand with the leading Shopify development agency in South Africa. From custom design to integration with local gateways like PayFast and Peach Payments — we build stores that convert.
              </motion.p>
              ...
              <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-8 relative overflow-hidden group hover:bg-white/10 transition-colors">
                <div className="flex items-center gap-4 mb-8">
                  ...
                  <div>
                    ...
                    <p className="text-white/40 text-sm">Johannesburg, Cape Town, Durban</p>
                  </div>
                </div>
                <div className="space-y-4">
                  {[
                    { icon: CreditCard, title: "SA Payment Gateways", desc: "PayFast, Peach Payments, Ozow, Yoco." },
                    { icon: Truck, title: "Logistics South Africa", desc: "The Courier Guy, DPD, Dawn Wing." },
                    { icon: Languages, title: "Multi-language Support", desc: "Optimized for the diverse SA market." },
                  ].map((item, i) => (
      ...
      <section className="bg-card border-b border-border py-6">
        <div className="container mx-auto px-6">
          <div className="flex flex-wrap justify-center items-center gap-8 md:gap-12">
            {[
              { val: "80+", label: "SA Stores Launched" },
              { val: "R100M+", label: "GMV Processed" },
              { val: "Local Support", label: "Dedicated Team" },
      ...
      <section className="py-16 md:py-24 bg-background">
        <div className="container mx-auto px-6 text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-8 text-foreground">Ready to Scale Your Brand in South Africa?</h2>
          <p className="text-muted-foreground mb-12 max-w-2xl mx-auto">Join the leading brands in South Africa that trust Globify for their Shopify success. Get your free strategy session today.</p>
      ...
      <section className="py-20 md:py-28 section-dark relative overflow-hidden">
        ...
        <div className="container mx-auto px-6 relative z-10 text-center">
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={stagger} className="max-w-2xl mx-auto">
            <motion.h2 variants={fadeUp} className="text-3xl md:text-4xl font-bold text-white mb-6">Create a Store That South African Customers Love</motion.h2>
            ...
            <motion.div variants={fadeUp} className="flex justify-center mb-8"><InlineLeadForm id="final-za" variant="dark" /></motion.div>
